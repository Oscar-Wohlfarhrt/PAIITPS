 ...
 * @author Oscar2
 */
public class ClienteTable extends javax.swing.JFrame {
    List<Cliente> values = MainController.mc.getClientes();
    DynamicTableModel<Cliente> tModel;
    /**
    ...
    public ClienteTable() {
        ...
        DynamicTable<Cliente> dynTable = new DynamicTable<>(Cliente.class);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClienteTable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
